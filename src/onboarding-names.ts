...
export const AGENT_NAME_POOL: readonly string[] = [
  "Reimu", "Sakuya", "Yukari", "Marisa", "Youmu", "Koakuma",
  "Reisen", "Yuyuko", "Aya", "Ran", "Sanae", "Suika", "Koishi", "Nue",
  "Chen", "Mokou", "Satori", "Remilia", "Suwako", "Momiji", "Tenshi",
  "Kaguya", "Komachi", "Nitori", "Charlotte", "Kasen", "Mima", "Yuuka",
  "Kogasa", "Rin", "Tewi", "Eirin", "Hina", "Kagerou", "Sumireko",
  "Kokoro", "Mamizou", "Rinnosuke", "Yumemi", "Akyuu", "Kanako", "Hatsune",
  "Shinki", "Shion", "Daiyousei", "Iku", "Miya", "Mai", "Meira", "Murasa",
  "Usagi", "Rei", "Yumi", "Miku", "Kira"
];
